...
import { PACKABLE_TYPES, TokenCount, on_syntax_version, on_package_name, on_enum, on_message, on_option, on_import, on_extend, on_service, Message, Extends, MAP_KEY_TYPES } from "./parser-internals";
