...
export const PACKABLE_TYPES = new Set([
    // varint wire types
...
export const MAP_KEY_TYPES = new Set([
    // varint wire types
    'int32', 'int64', 'uint32', 'uint64', 'sint32', 'sint64', 'bool',
    // + ENUMS
    // 64-bit wire types
...
const message_types = new WeakMap();
export class MessageField extends Options {
    ...
    set type_ref(v) {
        if (PRIMITIVE_TYPES.has(this.type))
            throw new SyntaxError('May not reference a primitive type on a MessageField');
        if (message_types.has(this))
            throw new ReferenceError('May not reference more than one type on a MessageField');
...
//# sourceMappingURL=parser-internals.mjs.map