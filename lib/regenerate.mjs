...
for (const file of new Set(Array.from(read_dir('test/fixtures'), v => basename(basename(v, '.proto'), '.json'))))
    try {
        ...
        if (neq || enoent) {
            if (owr) {
                ...
                write_file(pos + '.json', json_str_new, 'utf8');
...
//# sourceMappingURL=regenerate.mjs.map